...
import '../../../app_commons/ahcrm_text_field.dart';
...
class ViewForum extends StatefulWidget {
  ...
  @override
  _ViewForumState createState() => _ViewForumState(data:data,dataSend:dataSend);
}
                            ...
                            onPressed: () async {
                              await ForumServices()
                                ...
                                if (value["isSuccess"]) {
                                  ...
                                  // });
                                  Utilities().toastMessage("Deleted the forum successfully",
                                      cursorColour, Icons.done,width,context);
                                } else {
                                  // setState(() {
                                  //   isSavingMeating = false;
                                  // });
